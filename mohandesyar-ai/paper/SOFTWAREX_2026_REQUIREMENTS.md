...
SoftwareX is an open-access, peer-reviewed Elsevier Research Elements journal
for detailed descriptions of research software and its application, with an
emphasis on open science, discoverability, re-use, and reproducibility.

Official Research Elements page:
https://www.elsevier.com/researcher/author/tools-and-resources/research-elements-journals

Official SoftwareX Guide for Authors:
https://www.sciencedirect.com/journal/softwarex/publish/guide-for-authors

Official SoftwareX OSP template:
...
Code metadata records:
- current code version;
- permanent version-specific code/repository link;
- reproducible-capsule link when applicable;
- code license;
...
Software metadata records:
- current software version;
- permanent executable/public-version link;
...
## General Elsevier preparation rules applied
...
- empirical QA evidence;
- comparison with relevant field-data alternatives;
- potential impact without unsupported adoption claims;
