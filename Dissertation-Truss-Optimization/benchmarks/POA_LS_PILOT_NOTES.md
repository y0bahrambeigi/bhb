# BMPOA core vs BMPOA problem-aware-LS equal-budget pilot — Python mirror

> Naming correction: these results belong to the budgeted memetic Pelican
> implementation (`BMPOA-*`), not to the separate EPOA implementation in PR
> #33. The two result sets are complementary ablations and are not pooled.
...
- population: 70
- evaluator calls per run: 35,070
- seeds: 2026, 2027, 2028, 2029, 2030
- penalty coefficient: 1e7
- Levy scale: 0.015
- BMPOA-core-v1 local-search trials: 0
- BMPOA-problem-aware-ls-v1 local-search trials: 3
...
| Seed | BMPOA-core-v1 weight (lb) | BMPOA-problem-aware-ls-v1 weight (lb) |
| ---: | ---: | ---: |
...
All ten runs were feasible and used exactly 35,070 evaluator calls. The
25-bar evaluator solves two load cases per call, or 70,140 load-case solves.

| Statistic | BMPOA-core-v1 | BMPOA-problem-aware-ls-v1 |
| --- | ---: | ---: |
...
All ten runs were feasible and used exactly 35,070 evaluator calls.
...
1. `BMPOA-core-v1`
2. `BMPOA-problem-aware-ls-v1`
3. `BMPOA-restart-v1`
4. `BMPOA-problem-aware-ls-restart-v1`
