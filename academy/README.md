...
بستهٔ ZIP کامل و مستقل با نام `Python_Academy_Yousef_Bahram_Beigi_Offline_v2.0.zip` به‌صورت GitHub Release عمومی ساخته و منتشر می‌شود. نسخهٔ ChatGPT Library مدرس نیز به‌عنوان نسخهٔ پشتیبان نگهداری می‌شود.

<https://github.com/y0bahrambeigi/bhb/releases/tag/python-academy-v2.0.0>
